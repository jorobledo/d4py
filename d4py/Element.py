...
class elemento:
    ...
    def __init__(self, Iso_name, table=0, **kwargs):
        if (Iso_name in isotope_dict) is False:
            ...
            dic = dict(
                list(zip(nombres, isotope_dict[Iso_name]))
            )  # take parameters from table
            for key in dic:
            ...
            if table == 2:
                for key in isotope_dict:
                    if isotope_dict[key][0] == isotope_dict[Iso_name][0]:
                        ...
                        print("\n")
                        print(
                            "{:<10} {:<10} {:<10}".format("PARAMETER", "VALUE", "UNITS")
                        )
                        for key in doc:
                            print(
                                "{:<10} {:<10} {:<10}".format(key, dic[key], units[key])
                            )
...
def Complex(key, value):
    if isinstance(value, complex) is False:
